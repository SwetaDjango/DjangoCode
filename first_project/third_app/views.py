...
# # Part 2
def index(request):
    my_dict = {'insert_me': "Now I am coming from third_app/index.html! but from index1",
...
def helloworld(request):
    return render(request, 'third_app/helloworld.html', )
...
def static_index(request):
    return render(request, 'third_app/static_index.html', )
